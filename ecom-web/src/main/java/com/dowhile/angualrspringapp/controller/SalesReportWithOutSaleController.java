 ...
 */
@Controller
@RequestMapping("/salesReportWithOutSale")
public class SalesReportWithOutSaleController {
			...
			try {
				...
				if(reportType.equals("Revenue")){
					...
					if(!isHeadOffice && configuration!=null && configuration.getPropertyValue().toString().equalsIgnoreCase(ControllersConstants.TRUE)){
						...
						reportParams.setBaseColumn("sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,sum(Gross_Profit) as Profit,avg(Margin) as Margin,Tax");
					...
					reportParams.setTableName("SaleReport_withOutSale");
					...
					ReportParams reportParams = new ReportParams();
					reportParams.setBaseColumn("sum(Cost_of_Goods) as Cost,sum(Revenue) as Revenue,sum(Gross_Profit) as Profit,avg(Margin) as Margin,Tax");
					reportParams.setCompanyId(currentUser.getCompany().getCompanyId());
					reportParams.setEndDate(endDat);
					reportParams.setGroupBy("Product");
					reportParams.setMainBaseColumn("Product");
					...
					ReportParams reportParams = new ReportParams();
					reportParams.setBaseColumn("sum(Gross_Profit) as Profit,sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,avg(Margin) as Margin,Tax");
					reportParams.setCompanyId(currentUser.getCompany().getCompanyId());
					reportParams.setEndDate(endDat);
					reportParams.setGroupBy("Product");
					reportParams.setMainBaseColumn("Product");
					...
					ReportParams reportParams = new ReportParams();
					reportParams.setBaseColumn("sum(Items_Sold),sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,sum(Gross_Profit) as Profit,avg(Margin) as Margin,Tax");
					reportParams.setCompanyId(currentUser.getCompany().getCompanyId());
					reportParams.setEndDate(endDat);
					reportParams.setGroupBy("Product");
					reportParams.setMainBaseColumn("Product");
					...
					ReportParams reportParams = new ReportParams();
					reportParams.setBaseColumn("avg(Margin) as Margin,sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,sum(Gross_Profit) as Profit,Tax");
					reportParams.setCompanyId(currentUser.getCompany().getCompanyId());
					reportParams.setEndDate(endDat);
					reportParams.setGroupBy("Product");
					reportParams.setMainBaseColumn("Product");
					...
					if(!isHeadOffice && configuration!=null && configuration.getPropertyValue().toString().equalsIgnoreCase(ControllersConstants.TRUE)){
						...
						reportParams.setBaseColumn("sum(Revenue_tax_incl) as Revenue_Tax_Incl,sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,sum(Gross_Profit) as Profit,avg(Margin) as Margin,Tax");
						reportParams.setPrintColumns( reportType+","+ "Revenue,Cost of Goods,Gross Profit,Margin,Tax");
					...
					if(!isHeadOffice && configuration!=null && configuration.getPropertyValue().toString().equalsIgnoreCase(ControllersConstants.TRUE)){
						...
						reportParams.setBaseColumn("min(CREATED_DATE) as First,sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,sum(Gross_Profit) as Profit,avg(Margin) as Margin,Tax");
						reportParams.setPrintColumns( reportType+","+ "Revenue,Cost of Goods,Gross Profit,Margin,Tax");
					...
					if(!isHeadOffice && configuration!=null && configuration.getPropertyValue().toString().equalsIgnoreCase(ControllersConstants.TRUE)){
						...
						reportParams.setBaseColumn("max(CREATED_DATE) as Last,sum(Revenue) as Revenue,sum(Cost_of_Goods) as Cost,sum(Gross_Profit) as Profit,avg(Margin) as Margin,Tax");
						reportParams.setPrintColumns(  reportType+","+ "Revenue,Cost of Goods,Gross Profit,Margin,Tax");
