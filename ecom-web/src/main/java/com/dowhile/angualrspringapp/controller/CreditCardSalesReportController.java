...
public class CreditCardSalesReportController {
	...
	@RequestMapping(value = "/getCreditCardSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}", method = RequestMethod.POST)
	public @ResponseBody Response getCreditCardSalesReportByDateRange(@PathVariable("sessionId") String sessionId,
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(reportType.equals("Revenue")){
					...
					reportParams.setTableName("credit_sale");
