...
/**
 * StockSupplierTransferDetailsController
 * @constructor
 */
var StockSupplierTransferDetailsController = ['$scope', '$sce', '$http', '$timeout', '$window','$cookieStore','$rootScope','SessionService','StockSupplierTransferDetailsControllerPreLoad',function($scope, $sce, $http, $timeout, $window,$cookieStore,$rootScope,SessionService,StockSupplierTransferDetailsControllerPreLoad) {
	...
	$scope.sessionValidation = function(){
		...
		if(SessionService.validate()){
			...
			$scope.data = StockSupplierTransferDetailsControllerPreLoad.loadControllerData();
			$scope.fetchData();			
			$scope.isAdmin();
