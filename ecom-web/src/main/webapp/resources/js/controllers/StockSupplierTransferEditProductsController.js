...
/**
 * StockSupplierTransferEditProductsController
 * @constructor
 */
var StockSupplierTransferEditProductsController = ['$sce', '$scope', '$http', '$timeout', '$window','$cookieStore','$rootScope','SessionService','StockSupplierTransferEditProductsControllerPreLoad',function($sce, $scope, $http, $timeout, $window,$cookieStore,$rootScope,SessionService,StockSupplierTransferEditProductsControllerPreLoad) {
	...
	$scope.sessionValidation = function(){
		...
		if(SessionService.validate()){
			...
			$scope.data = StockSupplierTransferEditProductsControllerPreLoad.loadControllerData();
			$scope.fetchData();
