			...
			for(var i=0;i<$scope.productList.length;i++){
				if(!isNaN($scope.productList[i].compositeQunatity)){
					if(parseInt($scope.productList[i].compositeQunatity)<=parseInt($scope.productList[i].currentInventory)){
						var retailPric = parseFloat($scope.productList[i].retailPrice)*parseFloat($scope.productList[i].compositeQunatity);
						...
						var retailPric = parseFloat($scope.productList[i].retailPrice)*parseFloat($scope.productList[i].currentInventory);
						retailPrice = retailPrice+retailPric;
